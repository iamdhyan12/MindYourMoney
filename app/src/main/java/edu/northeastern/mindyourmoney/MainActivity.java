...
public class MainActivity extends AppCompatActivity implements TransactionsAdapter.OnTransactionDeletedListener{
        ...
        mindYourMoneyRef.orderByChild(path).equalTo(selectedDate)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        TransactionsAdapter transactionsAdapter = new TransactionsAdapter(MainActivity.this, transactions, MainActivity.this);
                        binding.transactionList.setLayoutManager(new LinearLayoutManager(MainActivity.this));
